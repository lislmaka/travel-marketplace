...
{{--            </ol>--}}
            ...
            <a class="carousel-control-prev" href="#popular_destinations" role="button" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </a>
            <a class="carousel-control-next" href="#popular_destinations" role="button" data-bs-slide="next">
