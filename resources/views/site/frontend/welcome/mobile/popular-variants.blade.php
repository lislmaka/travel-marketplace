@component('frontend.welcome.mobile.parts.bock_header',['header' => 'Популярные варианты отдыха'])
...
<div class="container-fluid">
    <div class="container-xl">
        ...
        <div id="popular_variants" class="carousel carousel-dark slide" data-bs-ride="carousel" data-bs-interval="false">
            ...
            <a class="carousel-control-prev" href="#popular_variants" role="button" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </a>
            <a class="carousel-control-next" href="#popular_variants" role="button" data-bs-slide="next">
    ...
    <div class="text-center mt-5">
        @include('frontend.welcome.desktop.parts.buttons',['btn_1_title' => 'Все варианты', 'btn_1_url' => '', 'count' => '1000'])
    </div>
</div>
