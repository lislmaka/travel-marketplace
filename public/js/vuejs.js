...
var app = new vue__WEBPACK_IMPORTED_MODULE_0__.default({
      ...
      if (this.event_options_checked_price) {
        this.event_options_checked_price.forEach(function (item, i, arr) {
          if (this.event_options_price.length > 0 && this.event_options_price[item].price) {
            ...
            var qo = this.quantity_options['op_' + item] ? this.quantity_options['op_' + item] : 1;
  ...
  methods: {
    ...
    downCount: function downCount(index) {
      if (index) {
        if (!this.quantity_options[index] || this.quantity_options[index] === 1) {
          vue__WEBPACK_IMPORTED_MODULE_0__.default.set(app.quantity_options, index, 1);
        } else {
          var increment = this.quantity_options[index];
          vue__WEBPACK_IMPORTED_MODULE_0__.default.set(app.quantity_options, index, --increment);
        }
      } else {
        if (this.quantity === 1) {
          this.quantity = 1;
    ...
    upCount: function upCount(index) {
      if (index) {
        if (this.quantity_options[index]) {
          var increment = this.quantity_options[index];
          vue__WEBPACK_IMPORTED_MODULE_0__.default.set(app.quantity_options, index, ++increment);
        } else {
          vue__WEBPACK_IMPORTED_MODULE_0__.default.set(app.quantity_options, index, 2);
        }
      } else {
        this.quantity++;
      }
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./resources/js/vuejs.js");
